...
function Topurarlar() {
  const [players, setPlayers] = useState([
    { id: 11, name: 'Shoxrux', age: 18, position: 'Forward', goals: 23 },
    { id: 3, name: 'Rasulbek', age: 19, position: 'Forward', goals: 21 },
    { id: 1, name: 'Javoxir', age: 17, position: 'Forward', goals: 18 },
    { id: 7, name: 'Azamat', age: 18, position: 'Forward', goals: 15 },
    { id: 2, name: 'Oqilbek', age: 19, position: 'Forward', goals: 14 },
    ...
    { id: 26, name: 'Muzaffer', age: 16, position: 'Defender', goals: 2 },
    { id: 26, name: 'Mirsaid', age: 16, position: 'Forward', goals: 2 },
