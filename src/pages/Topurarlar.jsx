...
function Topurarlar() {
  const [players, setPlayers] = useState([
    { id: 11, name: 'Shoxrux', age: 18, position: 'Forward', goals: 15 },
    { id: 3, name: 'Rasulbek', age: 19, position: 'Forward', goals: 13 },
    { id: 1, name: 'Javoxir', age: 17, position: 'Forward', goals: 12 },
    { id: 7, name: 'Azamat', age: 18, position: 'Forward', goals: 10 },
    { id: 9, name: 'Akobir', age: 16, position: 'Forward', goals: 9 },
    { id: 5, name: 'Ismoil', age: 18, position: 'Midfielder', goals: 8 },
    ...
    { id: 16, name: 'Shaxriyor', age: 17, position: 'Midfielder', goals: 1 },
  ]);
