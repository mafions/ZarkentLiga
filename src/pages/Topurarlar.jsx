...
function Topurarlar() {
  const [players, setPlayers] = useState([
    { id: 11, name: 'Shoxrux', age: 18, position: 'Forward', goals: 31 },
    { id: 3, name: 'Rasulbek', age: 19, position: 'Forward', goals: 22 },
    { id: 1, name: 'Javoxir', age: 17, position: 'Forward', goals: 21 },
    { id: 7, name: 'Azamat', age: 18, position: 'Forward', goals: 18 },
    { id: 2, name: 'Oqilbek', age: 19, position: 'Forward', goals: 16 },
    { id: 5, name: 'Ismoil', age: 18, position: 'Midfielder', goals: 16 },
    { id: 9, name: 'Akobir', age: 16, position: 'Forward', goals: 9 },
    { id: 15, name: 'Nurmuhammad', age: 18, position: 'Forward', goals: 7 },
    { id: 10, name: 'Dovudbek', age: 18, position: 'Forward', goals: 7 },
    { id: 26, name: 'Mirsaid', age: 16, position: 'Forward', goals: 7 },
    { id: 26, name: 'Muzaffer', age: 16, position: 'Defender', goals: 7 },
    { id: 14, name: 'Ozodbek', age: 18, position: 'Defender', goals: 6 },
    { id: 6, name: 'Bunyodbek', age: 22, position: 'Forward', goals: 6 },
    { id: 9, name: 'Akmal', age: 16, position: 'Defender', goals: 5 },
    ...
    { id: 25, name: 'Shoxjaxon', age: 16, position: 'Goalkeapper', goals: 2 },
    { id: 28, name: 'Mirzadavlat', age: 16, position: 'Defender', goals: 2 },
