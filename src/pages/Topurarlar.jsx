...
function Topurarlar() {
    const [players, setPlayers] = useState([
        { id: 8, name: 'Abrorbek (1995)', age: "?", position: 'Forward', goals: 17, reputation: "" },
        { id: 4, name: 'Javoxir (2007)', age: 17, position: 'Forward', goals: 13, reputation: "" },
        ...
        { id: 17, name: 'Dovudbek', age: "2006", position: 'Forward', goals: 2, reputation: "" },
        ...
        { id: 20, name: 'Dostonbek (1992)', age: "?", position: 'Forward', goals: 1, reputation: "" },
