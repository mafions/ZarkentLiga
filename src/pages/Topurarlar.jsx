...
function Topurarlar() {
  const [players, setPlayers] = useState([
    { id: 11, name: 'Shoxrux', age: 18, position: 'Forward', goals: 17 },
    { id: 1, name: 'Javoxir', age: 17, position: 'Forward', goals: 15 },
    { id: 3, name: 'Rasulbek', age: 19, position: 'Forward', goals: 13 },
    { id: 7, name: 'Azamat', age: 18, position: 'Forward', goals: 13 },
    { id: 9, name: 'Akobir', age: 16, position: 'Forward', goals: 9 },
    { id: 5, name: 'Ismoil', age: 18, position: 'Midfielder', goals: 9 },
    { id: 2, name: 'Oqilbek', age: 19, position: 'Forward', goals: 6 },
    ...
    { id: 6, name: 'Bunyodbek', age: 22, position: 'Forward', goals: 5 },
    { id: 12, name: 'Mirshohid', age: 16, position: 'Forward', goals: 4 },
    { id: 8, name: 'Husanboy', age: 17, position: 'Forward', goals: 3 },
    { id: 14, name: 'Ozodbek', age: 18, position: 'Defender', goals: 3 },
    { id: 23, name: 'Sharofiddin', age: 22, position: 'Forward', goals: 3 },
